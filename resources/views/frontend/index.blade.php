            ...
            <div class="item">
              <div class="products">
                ...
                <div class="product-info text-left m-t-20">
                  ...
                  @if(session()->get('language') == 'sinhala') {{ $product->product_name_sin }} @else {{ $product->product_name_en }} @endif</a></h3>
    </a></h3>
                  <div class="rating rateit-small"></div>
                  <div class="product-price">
                    @if($discount==NULL)
                    <span class="price">{{$product->selling_price}}</span> </div>
                    @else
  ...
  <li><a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab">{{ $category->category_name_en }}</a></li>
       ...
       <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img  src="{{ asset($product->product_thambnail) }}" alt=""></a> </div>
        ...
        <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
@if(session()->get('language') == 'sinhala') {{ $product->product_name_sin }} @else {{ $product->product_name_en }} @endif
            </a></h3>
          <div class="rating rateit-small"></div>
